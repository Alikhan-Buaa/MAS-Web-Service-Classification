...
# General Settings
# =============================================================================
CATEGORY_SIZES = [10, 20, 30, 40, 50]  # Number of top categories to use
...
RESULTS_CONFIG = {
    ...
    "ml_category_paths": { 
        10: RESULTS_PATH / "ml" / "top_10_categories", 
        20: RESULTS_PATH / "ml" / "top_20_categories", 
...
# =============================================================================
# Ensure Required Directories - Updated with uniform naming
# =============================================================================
for path in [
    ANALYSIS_PATH,
    PREPROCESS_PATH,
